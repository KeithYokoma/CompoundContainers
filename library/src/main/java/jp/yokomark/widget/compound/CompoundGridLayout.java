...
public class CompoundGridLayout extends GridLayout implements Checkable, CompoundViewGroup {
    ...
    public CompoundGridLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public CompoundGridLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public CompoundGridLayout(Context context, AttributeSet attrs, int defStyle) {
